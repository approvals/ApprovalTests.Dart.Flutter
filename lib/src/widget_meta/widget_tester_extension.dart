...
extension WidgetTesterExtension on WidgetTester {
  /// Sets the class whose members are localized strings.
  ///
  /// Typically the `S` class generated by the intl package, but any class of
  /// this shape works:
  ///
  ///     class MyTextHolder {
  ...
  ///     }
  ///
  /// The value belongs to the current capture session, so
  /// `ApprovalWidgets.tearDownAll()` clears it.
  static set s(dynamic value) => currentApprovalSession.intlStrings = value;

  /// The class whose members are localized strings, or null if unset.
  static dynamic get s => currentApprovalSession.intlStrings;
